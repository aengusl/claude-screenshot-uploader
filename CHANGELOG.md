...
### Changed
- File detection now matches macOS's default screenshot naming (`Screenshot ....png` / `Screen Shot ....png`) instead of the third-party `SCR-*.png` pattern, so no extra screenshot app is required
